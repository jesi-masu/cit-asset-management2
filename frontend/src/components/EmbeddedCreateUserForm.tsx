...
const EmbeddedCreateUserForm: React.FC<Props> = ({ onSuccess, formData, setFormData }) => {
  // --- Data Sources ---
  ...
  const filteredDepartments = departments.filter(
    (dept) =>
      (!formData.selectedCampus || dept.campus_id === Number(formData.selectedCampus)) &&
  ...
  const filteredLabs = laboratories.filter(
    (lab) => !formData.selectedDept || lab.dept_id === Number(formData.selectedDept),
  );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                onChange={(e) => setFormData({ ...formData, selectedCampus: e.target.value })}
              >
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                onChange={(e) => setFormData({ ...formData, selectedOfficeType: e.target.value })}
              >
            ...
            <div className="md:col-span-2">
              ...
              <select
                ...
                disabled={!formData.selectedCampus && !formData.selectedOfficeType}
                onChange={(e) => setFormData({ ...formData, selectedDept: e.target.value })}
              >
